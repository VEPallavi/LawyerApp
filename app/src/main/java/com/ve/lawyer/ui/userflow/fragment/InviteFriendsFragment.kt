...
class InviteFriendsFragment: Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        mView = inflater.inflate(R.layout.fragment_invite_friends, container, false)
        setupToolbar()
        setupClickListener()
        return mView
    }
    ...
    private fun setupToolbar() {
        (activity as UserHomeActivity).setToolbarTitle(activity?.resources?.getString(R.string.invite_friend)!!)
